	...
	<nav id="navbar">
		<div class="container">
				...
				<ul>
					...
					<li><a href="#">FAQ</a></li>
					<li><a href="sponinfo.php">Your details</a></li>
	...
	<div class="container1>
		<div id="container">
			<section id="main">
				...
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="Amittrivedi">
				<img src="img/at.png" alt="ERROR">
				<button type="submit" class="btn btn-primary"> Sponsor </button>
				</form></li>
				
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="The Hunt">
				...
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="cryptography">
				<img src="img/crypt.png" alt="ERROR">
				<button type="submit" class="btn btn-primary"> Sponsor </button>
				</form></li>
				
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="Varun Thakur">
				...
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="Pes Pubg Tournament">
				<img src="img/pubg.jpg" alt="ERROR">
				<button type="submit" class="btn btn-primary"> Sponsor </button>
				</form></li>
				
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="Talent show">
				<img src="img/taalent.jpeg" alt="ERROR">
				<button type="submit" class="btn btn-primary"> Sponsor </button>
				</form></li>
				
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="Stockpile">
				...
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="The Idea">
				<img src="img/ideathon.jpg" alt="ERROR">
				<button type="submit" class="btn btn-primary"> Sponsor </button>
				</form></li>
				
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="Network security CTF">
				<img src="img/net.jpeg" alt="ERROR">
				<button type="submit" class="btn btn-primary"> Sponsor </button>
				</form></li>
				
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="Dot slash">
				<img src="img/dot.png" alt="ERROR">
				<button type="submit" class="btn btn-primary"> Sponsor </button>
				</form></li>
				
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="prakalpa project display">
				<img src="img/prak.jpeg" alt="ERROR">
				<button type="submit" class="btn btn-primary"> Sponsor </button>
				</form></li>
				
				<li><form method="post" action="spform.php">
				<input type="hidden" name="ename" value="Datathon19">
